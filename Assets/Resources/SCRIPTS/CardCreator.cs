...
public class CardCreator : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            CreateCard("axe", "axe", TType.white, "axe", "axe", Icons, "Sillhuettes/AxeSilhuette");
    ...
    void CreateCard(string title, string type, TType ttype, string description, string tags, GameObject[] icons, string silhuettepath)
    {
